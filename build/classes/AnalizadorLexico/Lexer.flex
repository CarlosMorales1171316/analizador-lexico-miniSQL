...
/*DML*/
/*SELECT*/
select_list = ((["*"] | ({Identificador}"."{Identificador} | {Identificador}) | ({expression} ({WhiteSpace}* (("AS"){WhiteSpace}+)? {Identificador})?)  |  ({Identificador} {WhiteSpace}* ["="] {WhiteSpace}* {expression}) | (("COUNT") {WhiteSpace}* ["("] {WhiteSpace}* ({Identificador}|["*"]|{Digito}) {WhiteSpace}* [")"]) | (("SUM") {WhiteSpace}* ["("] {WhiteSpace}* {Identificador} {WhiteSpace}* [")"]) | ((("AVG") {WhiteSpace}* ["("] {WhiteSpace}* {Identificador} {WhiteSpace}* [")"])) | ({Identificador} {WhiteSpace}* ["."] {WhiteSpace}* ["*"])) ({WhiteSpace}* [","] {WhiteSpace}* (["*"] | ({Identificador}"."{Identificador} | {Identificador}) | ({expression} ({WhiteSpace}* (("AS"){WhiteSpace}+)? {Identificador})?)  |  ({Identificador} {WhiteSpace}* ["="] {WhiteSpace}* {expression})))*)
...
select = {WhiteSpace}*
GroupBy = (({group_by_expression}| ("ROLLUP") {WhiteSpace}* {group_by_expression} | ("CUBE") {WhiteSpace}* {group_by_expression} | ("GROUPING") {WhiteSpace}* ("SETS") {WhiteSpace}* {group_by_expression}))
group_by_expression = (((("ALL"){WhiteSpace}*{Identificador})|({Identificador})|({WhiteSpace}* ["("] {Identificador} {WhiteSpace}* [")"])) ({WhiteSpace}* [","] {WhiteSpace}* ((("ALL"){WhiteSpace}*{Identificador})|({Identificador})|({WhiteSpace}* ["("] {Identificador} {WhiteSpace}* [")"])))*)
OrderBy =   (("ORDER") {WhiteSpace}+ ("BY") {WhiteSpace}+ ({Identificador}|{expression}) {WhiteSpace}* (("ASC")|("DESC"))? ({WhiteSpace}* [","] {WhiteSpace}*("ORDER") {WhiteSpace}+ ("BY") {WhiteSpace}+ ({Identificador}|{expression}) {WhiteSpace}* (("ASC")|("DESC"))?)*)
Select = (("SELECT") ({WhiteSpace}+(("ALL")|("DISTINCT")))? ({WhiteSpace}+("TOP") {WhiteSpace}* ({Digito}|["("]{WhiteSpace}*{Digito}{WhiteSpace}*[")"]) ({WhiteSpace}+("PERCENT"))?)? {WhiteSpace}+ {select_list} ({WhiteSpace}* ("INTO") {WhiteSpace}* {Identificador})? ({WhiteSpace}* ("FROM") {WhiteSpace}* {from})? ({WhiteSpace}* ("WHERE") {WhiteSpace}* {Where})? ({WhiteSpace}* ("GROUP"){WhiteSpace}* ("BY") {WhiteSpace}* {GroupBy})?  ({WhiteSpace}* ("HAVING") {WhiteSpace}* {Where})? ({WhiteSpace}* {OrderBy})?)
